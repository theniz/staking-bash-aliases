...
# Update (22/08/31)
alias s.update='cd ~ && rm ~/.bash_aliases && curl -O https://raw.githubusercontent.com/theniz/staking-bash-aliases/main/.bash_aliases && source ~/.bash_aliases && echo \“Shortcut Keys Updated Seccessfully...\"'
