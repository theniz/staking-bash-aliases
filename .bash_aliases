...
alias p.start='echo \“Wait for 20s .….\” && sudo systemctl start beacon && sleep 10s && sudo systemctl start validator && sleep 10s && sudo systemctl start slasher && echo \“Done.\"'
alias p.stop='echo \”Wait for 10s …..\” && sudo systemctl stop slasher && sleep 5s && sudo systemctl stop validator && sleep 5s && sudo systemctl stop beacon && echo \”Done.\"'
...
alias s.start='sudo systemctl start slasher'
alias s.stop='sudo systemctl stop slasher'
...
alias s.log='sudo journalctl -f -u slasher.service'
...
alias s.init='sudo systemctl start slasher && sudo journalctl -f -u slasher.service'
alias n.disable='sudo systemctl disable geth && sudo systemctl disable beacon && sudo systemctl disable validator && sudo systemctl disable slasher'
alias n.enable='sudo systemctl enable geth && sudo systemctl enable beacon && sudo systemctl enable validator && sudo systemctl enable slasher'
...
alias s.edit='sudo nano /etc/systemd/system/slasher.service'
...
alias s.status='sudo systemctl status slasher'
alias n.size='sudo du -hs /home/eth2/eth1 && sudo du -hs /home2/eth2/eth1 && sudo du -hs /home/eth2/beacon && sudo du -hs /home/eth2/validator && sudo du -hs /home/eth2/slasher && df -h --total | grep total'
...
alias s.health='curl http://localhost:8082/healthz'
...
alias s.enable="sudo systemctl enable slasher"
...
alias s.disable="sudo systemctl disable slasher"
alias b.tpeer="curl -s http://localhost:8080/metrics | grep \"p2p_topic_peer_count\""
alias n.ctemp="cat /sys/class/thermal/thermal_zone*/temp"
...
alias s.error="sudo journalctl -u slasher | grep -e warning -e error | tail -30"
